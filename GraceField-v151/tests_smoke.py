...
# V1.2.50 — regressão: classificação automática CNIS deve substituir estado
# automático/legado e somente confirmação manual explícita pode prevalecer.
from classificador_previdenciario import classificar_fontes as _classificar_fontes_v1250
_df_v1250 = _pd_cnis.DataFrame([{
    'cnpj_declarante': '05.066.423/0001-28',
    'rendimento_tributavel': 10000.0,
    'previdencia_oficial': 499.0,
    'tipo_competencia': 'mensal',
    'codigo_receita': '0588',
...
_cnis_v1250 = {
    '05066423000128': [{
        ...
        'cooperacao': 'nao_cooperado',
    }]
}
# Estado legado/automático incorreto: deve ser recalculado para 11%.
_r_v1250 = _classificar_fontes_v1250(
    _df_v1250,
    ['05.066.423/0001-28'],
    {'05.066.423/0001-28': 'progressiva'},
    {'05.066.423/0001-28': {'origem_classificacao': 'automatico'}},
    _cnis_v1250,
)
assert _r_v1250['05.066.423/0001-28']['classificacao_sugerida'] == '11'
assert _r_v1250['05.066.423/0001-28']['classificacao_final'] == '11'
assert _r_v1250['05.066.423/0001-28']['fonte_classificacao'] == 'CNIS'

# Decisão manual explicitamente confirmada: deve prevalecer sobre o CNIS.
_r_v1250_manual = _classificar_fontes_v1250(
    _df_v1250,
    ['05.066.423/0001-28'],
    {'05.066.423/0001-28': 'progressiva'},
    {'05.066.423/0001-28': {
...
assert _r_v1250_manual['05.066.423/0001-28']['classificacao_sugerida'] == '11'
assert _r_v1250_manual['05.066.423/0001-28']['classificacao_final'] == 'progressiva'
assert _r_v1250_manual['05.066.423/0001-28']['origem_classificacao'] == 'usuario'
print('OK — V1.2.50: CNIS prevalece sobre classificação automática/legada; confirmação manual explícita prevalece sobre o CNIS.')
